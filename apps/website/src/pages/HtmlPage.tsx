    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto flex max-w-5xl flex-col gap-28 px-6 pb-20 pt-20 md:gap-36 md:px-10 md:pt-32">
        <section className="flex flex-col items-center gap-10 text-center animate-fade-in-up">
          ...
          <div className="grid w-full max-w-4xl gap-5 text-left md:grid-cols-3">
            <InstallCard label="Install" command="bun add overflow-guard-html" />
            <InstallCard
              label="Use with a script tag"
        ...
        <section className="flex flex-col gap-5">
          <h2 className="font-display text-2xl font-semibold tracking-tight md:text-3xl">
            Or directly using a &lt;script&gt; tag
          </h2>
          <p className="max-w-3xl text-lg leading-relaxed text-muted-foreground">
            ...
            setups, this is the simplest raw HTML path. The root jsDelivr URL
            serves the browser bundle and registers the element automatically.
          </p>
